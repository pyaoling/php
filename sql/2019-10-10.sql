...
CREATE TABLE IF NOT EXISTS `tg_friend` (
  ...
  `tg_content` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT '请求的内容',
  `tg_state` tinyint(1) NOT NULL DEFAULT '0' COMMENT '验证信息',
...
(1, 'pingzi', 'pingzi', '??????????', 0, '2019-10-09 23:44:57'),
(2, '99999', 'pingzi', '??????????', 0, '2019-10-09 23:47:49'),
(3, 'pyaoling', 'pingzi', '我非常想和你交朋友。', 0, '2019-10-09 23:50:27');
...
CREATE TABLE IF NOT EXISTS `tg_message` (
  ...
  `tg_touser` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '收信人',
  `tg_fromuser` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '发信人',
  `tg_content` varchar(200) CHARACTER SET utf8 NOT NULL COMMENT '发信内容',
...
(7, 'pyaoling', 'pingzi', '1231231231232132131231312312', 1, '2019-10-04 20:51:16'),
(8, 'pingzi', 'pingzi', 'adadgdgsgfsfg', 1, '2019-10-04 20:51:32'),
(9, '111111', 'pingzi', 'asfsdfadfasdfasdfasdfsafasdfdsfa', 1, '2019-10-04 20:51:47'),
(10, '12346666', 'pingzi', '12345677777777sfsdfsfsfsfsd', 1, '2019-10-04 20:52:03'),
(13, 'pingzi', 'pingzi', '塔顶栽植东走西顾声东击西塔顶栽植东走西顾声东击西塔顶栽植东走西顾声东击西塔顶栽植东走西顾声东击西', 1, '2019-10-06 00:34:44'),
(14, 'pingzi', 'pingzi', '12322131231313123131313131313123123', 0, '2019-10-06 00:53:56');
...
(25, '43b66fe0944406e1450021a84edfd5d5c337e56a', '', 'pingzi', '3d4f2bf07dc1be38b20cd6e46949a1071f9d0e3d', '我的学校在哪里？', '1a6d3bf64c420a790319aeb8060d8f320be87d85', '12jl@qq.com.cnt', '123456', 'http://www.hao9669.com', '男', 'face/m27.gif', 1, '2019-09-14 18:28:29', '2019-10-02 16:27:33', '::1', 5),
